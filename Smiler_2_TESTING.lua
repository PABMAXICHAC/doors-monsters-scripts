...
Creator.runEntity = function(entity)
    ...
    Connections[entity.Model].Movement = RS.Stepped:Connect(function()
	   ...
	   effect:PivotTo(entity.Model.SmilerNew.CFrame - Vector3.new(0,3,0))
	   effect.Chain1.Attachment:FindFirstChildOfClass("Beam").Attachment1 = entity.Model.SmilerNew.Attachment
	   effect.Chain2.Attachment:FindFirstChildOfClass("Beam").Attachment1 = entity.Model.SmilerNew.Attachment
	   effect.Chain3.Attachment:FindFirstChildOfClass("Beam").Attachment1 = entity.Model.SmilerNew.Attachment
	   effect.Chain4.Attachment:FindFirstChildOfClass("Beam").Attachment1 = entity.Model.SmilerNew.Attachment
           wait(0.5)
	   local ts = game:GetService("TweenService")
           ts:Create(entity.Model.SmilerNew,TweenInfo.new(2, Enum.EasingStyle.Sine,Enum.EasingDirection.In),{CFrame = entity.Model.SmilerNew.CFrame + Vector3.new(0,20,0)}):Play()
           wait(2)
	   effect:Destroy()
